...
def build_master():
    ...
    # OMS
    oms_raw = pd.read_excel(data_dir/'WHO_COVID_Excess_Deaths_EstimatesByCountry.xlsx', engine='openpyxl',
                            sheet_name='Deaths by year', header=None, engine='openpyxl')
    ...
    # INFORM
    inf = pd.read_csv(data_path('inform_trend'), engine='openpyxl')
...
dash.register_page(__name__, path='/', name='★ Validez Predictiva', order=1)
